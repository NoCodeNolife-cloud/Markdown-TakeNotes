...
网络存在`滤波数据库`、`传输端口` `状态监测`、`队列管理`。这些都用于解决网络资源分配与调度问题。而 IEEE 802． 1Qat所采用的流预留协议 ( stream reservation protocol，SＲP) 机制是一个对 TSN 进行配置的标准。其在 2010 年 SＲP 标准化成为 IEEE 802． 1Qat，并入 IEEE 802． 1Q-2011 标准中。SＲP定义 了OSI 模型第2层的流概念。 
